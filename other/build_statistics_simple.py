...
spark.read.json(
    "gs://europe-west1-training-airfl-d9a9700f-data/data/{}-*.json".format(dt)
).withColumn(
...
(
    ...
    .parquet("gs://europe-west1-training-airfl-d9a9700f-data/average_prices/transfer_date={}/".format(dt))
)
